...
public class CaixaFxController {
    ...
    private void abrirCaixa() {
        try {
            ...
            Funcionario funcionario = sessionInfo.getAuthenticatedUser();
    ...
    private void fecharCaixa() {
        try {
            ...
            Long id = caixaTable.getSelectionModel().getSelectedItem() != null
                    ? caixaTable.getSelectionModel().getSelectedItem().getId()
                    : null;
    ...
    private void carregarCaixas() {
        caixaTable.getItems().setAll(caixaService.listarTodos());
    }
